...
import { MoodFromBackend, Time } from "@/lib/interfaces";
import { editMood, errorHandler } from "@/lib/ApiService";
...
const EditMood = ({
  ...
  entry: MoodFromBackend;
  handleEdit: (updatedEntry: MoodFromBackend) => void;
  handleClose: () => void;
}) => {
  const [formState, setFormState] = useState<MoodFromBackend>(entry);
